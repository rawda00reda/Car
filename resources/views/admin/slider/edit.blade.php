...
@section('content')
    ...
    <form  role="form" method="POST"
          action="{{action('SliderController@update',$slider)}}"
...
{{--                <input type="text" id="title_en" name="title_en" class="form-control"  value="{{$slider->title_en}}" />--}}
...
{{--                          style="width: 100%; height: 150px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;">{{$slider->body_ar}}</textarea>--}}
...
{{--                          style="width: 100%; height: 150px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;">{{$slider->body_en}}</textarea>--}}
...
{{--                          style="width: 100%; height: 150px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;">{{$slider->body_ur}}</textarea>--}}
...
{{--            </div>--}}
            ...
            <div class="form-group col-lg-8 {{ $errors->has('img') ? ' has-error' : '' }}">
                ...
                <img class="card-img-top" src="{{ asset('images/sliders/' . $slider->img) }} " style="width:200px;height:200px;" >
        ...
        <div class="modal-footer">
            <div class="box-body col-md-10 col-sm-offset-1">
                <a href="/admin/slider" type="button" class="btn btn-default pull-left"
